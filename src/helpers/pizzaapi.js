...
class PizzaTimeServer {
    ...
    // Page call
     fetchPage(pageNum,cb) {
        fetch(serverURL + "/pages/detail/" + pageNum)
            ...
            .catch(error => { console.log("Error: ", error)}) // handle the error
    }
    ...
    updateAccount(accountObject,cb) {
        ...
        .then(json => cb(json))
        .catch(error => { console.log("Error updating account: ", error)})
    }
    ...
    submitAccount(accountObject,cb) {
        ...
        .then(response => response.json())
        .then(json => cb(json))
        .catch(error => { console.log("Error creating account: ", error)})
    }
